...
DROP TABLE IF EXISTS game_rating.user;

CREATE TABLE game_rating.user(
...
INSERT INTO game_rating.user(user_id, nick, password) VALUES
(1,'Bartek2002', 'password'),
(2,'Aryna321', 'password');

DROP TABLE IF EXISTS game_rating.genre;

CREATE TABLE game_rating.genre(
  genre_id INT NOT NULL AUTO_INCREMENT,
  genre_name VARCHAR(50) DEFAULT NULL,
  CONSTRAINT pk_genre PRIMARY KEY (genre_id)
);

INSERT INTO game_rating.genre(genre_id, genre_name) VALUES
(1,'Action'),
(2,'Adventure'),
(3,'Fighting'),
(4,'Misc'),
...
DROP TABLE IF EXISTS game_rating.publisher;

CREATE TABLE game_rating.publisher(
  publisher_id INT NOT NULL AUTO_INCREMENT,
  publisher_name VARCHAR(100) DEFAULT NULL,
  CONSTRAINT pk_publisher PRIMARY KEY (publisher_id)
);

INSERT INTO game_rating.publisher(publisher_id, publisher_name) VALUES
(1,'10TACLE Studios'),
(2,'1C Company'),
...
DROP TABLE IF EXISTS game_rating.platform;

CREATE TABLE game_rating.platform(
  platform_id INT NOT NULL AUTO_INCREMENT,
  platform_name VARCHAR(50) DEFAULT NULL,
  CONSTRAINT pk_platform PRIMARY KEY (platform_id)
);

INSERT INTO game_rating.platform (platform_id, platform_name) VALUES
(1,'Wii'),
(2,'NES'),
(3,'GB'),
(4,'DS'),
